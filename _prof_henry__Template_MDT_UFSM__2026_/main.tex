...
% % % DATA DA DEFESA 
\data{15}{12}{2026} %% FORMATO {DD}{MM}{AAAA}
...
\include{capítulos/introdução}
\include{capítulos/fundamentação_teórica}
\include{capítulos/trabalhos_relacionados}
\include{capítulos/objetivos}
\include{capítulos/cronograma}
\include{capítulos/metodologia}
\include{capítulos/experimentos}
\include{capítulos/conclusão}
